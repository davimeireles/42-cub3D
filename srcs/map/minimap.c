...
/*   Updated: 2024/07/17 20:05:54 by dmeirele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	tile_n(t_player *player, t_cub3d *cub3d)
{
	if (player->dir_x < -0.66)
	{
		if (player->dir_y > -0.33 && player->dir_y < 0.33)
			ft_put_img(cub3d, (int[2]) {86, 81}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y > 0.33 && player->dir_y < 0.66)
			ft_put_img(cub3d, (int[2]) {84, 81}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y > 0.66 && player->dir_y < 1)
			ft_put_img(cub3d, (int[2]) {82, 81}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y < -0.33 && player->dir_y > -0.66)
			ft_put_img(cub3d, (int[2]) {88, 81}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y < -0.66 && player->dir_y > -1)
			ft_put_img(cub3d, (int[2]) {90, 81}, (int[2]) {2, 1}, GREEN);
	}
}
...
void	tile_s(t_player *player, t_cub3d *cub3d)
{
	...
	{
		if (player->dir_y > -0.33 && player->dir_y < 0.33)
			ft_put_img(cub3d, (int[2]) {86, 89}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y > 0.33 && player->dir_y < 0.66)
			ft_put_img(cub3d, (int[2]) {84, 89}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y > 0.66 && player->dir_y < 1)
			ft_put_img(cub3d, (int[2]) {82, 89}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y < -0.33 && player->dir_y > -0.66)
			ft_put_img(cub3d, (int[2]) {88, 89}, (int[2]) {2, 1}, GREEN);
		if (player->dir_y < -0.66 && player->dir_y > -1)
			ft_put_img(cub3d, (int[2]) {90, 89}, (int[2]) {2, 1}, GREEN);
	}
}
...
void	tile_w(t_player *player, t_cub3d *cub3d)
{
	if (player->dir_y < -0.66)
	{
		if (player->dir_x > -0.33 && player->dir_x < 0.33)
			ft_put_img(cub3d, (int[2]) {90, 85}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x > 0.33 && player->dir_x < 0.66)
			ft_put_img(cub3d, (int[2]) {90, 87}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x > 0.66 && player->dir_x < 1)
			ft_put_img(cub3d, (int[2]) {90, 89}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x < -0.33 && player->dir_x > -0.66)
			ft_put_img(cub3d, (int[2]) {90, 83}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x < -0.66 && player->dir_x > -1)
			ft_put_img(cub3d, (int[2]) {90, 81}, (int[2]) {2, 1}, GREEN);
	}
}
...
void	tile_e(t_player *player, t_cub3d *cub3d)
{
	...
	{
		if (player->dir_x > -0.33 && player->dir_x < 0.33)
			ft_put_img(cub3d, (int[2]) {82, 85}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x > 0.33 && player->dir_x < 0.66)
			ft_put_img(cub3d, (int[2]) {82, 87}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x > 0.66 && player->dir_x < 1)
			ft_put_img(cub3d, (int[2]) {82, 89}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x < -0.33 && player->dir_x > -0.66)
			ft_put_img(cub3d, (int[2]) {82, 83}, (int[2]) {2, 1}, GREEN);
		if (player->dir_x < -0.66 && player->dir_x > -1)
			ft_put_img(cub3d, (int[2]) {82, 81}, (int[2]) {2, 1}, GREEN);
	}
}
