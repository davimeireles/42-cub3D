...
/*   Updated: 2024/07/14 20:12:47 by txisto-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static void	player_direction_we(t_cub3d *cub3d);
static void	player_direction_ns(t_cub3d *cub3d);
...
void	player_init(t_cub3d *cub3d)
{
	...
	cub3d->player->rotation = 0.01;
	player_direction_we(cub3d);
	player_direction_ns(cub3d);
}
